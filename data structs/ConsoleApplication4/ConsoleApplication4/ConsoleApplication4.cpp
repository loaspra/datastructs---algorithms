...
public:
    ...
    void rutas_aux(int pos, int meta)
    {
        marca[pos] = 1;
        ruta.push_back(pos);
    ...
    void rutas(int pos, int meta)
    {
        rutas_aux(pos, meta);
    }

    void rutas_2(int pos, int meta, ListaArreglo<int> h)
    {
        cout << "Dijkstra : ";
        auto dijs = dijkstra(pos, meta);
        cout << dijs << endl;
        cout << "Greedy   : ";
        auto gree = greedy(pos, meta, h);
        cout << gree << endl;
        cout << "A*       : ";
        auto star_g = estrella(pos, meta, h);
        cout << star_g << endl;
    }
